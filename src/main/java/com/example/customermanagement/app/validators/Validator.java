...
public class Validator {
    public static final String FIRST_NAME_CANNOT_BE_LONGER_THAN_45_CHARACTERS = "First name cannot be longer than 45 characters.";
    public static final String LAST_NAME_CANNOT_BE_LONGER_THAN_45_CHARACTERS = "Last name cannot be longer than 45 characters.";
    public static final String INVALID_ADDRESS_EMAIL_PATTERN = "Invalid address email pattern.";
    public static final String CITY_CANNOT_BE_LONGER_THAN_45_CHARACTERS = "City cannot be longer than 45 characters.";
    public static final String STREET_CANNOT_BE_LONGER_THAN_45_CHARACTERS = "Street cannot be longer than 45 characters.";
    public static final String PHONE_NUMBER_CANNOT_BE_LONGER_THAN_9_CHARACTERS = "Phone number cannot be longer than 9 characters.";
    public static final String INVALID_DATE_PATTERN = "Invalid date pattern.";
    public static final String COMPANY_NAME_CANNOT_BE_LONGER_THAN_45_CHARACTERS = "Company name cannot be longer than 45 characters.";
